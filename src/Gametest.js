...
let testCase = [
    ...
    [
        '0xd24eceF3AA9257383BD3341e63F6Cd73951186dF',
    ...
    [
        '0xbAA740937169387fcE3c59658b23199b65102D5a',
        ethers.parseEther('0.02'),
        ethers.ZeroAddress,
        ethers.parseEther('0.04'),
        6,
    ...
    [
        '0x4aA738e75ca61716335A924f01141bF87C792647',
        ethers.parseEther('0.01'),
        ethers.ZeroAddress,
        ethers.parseEther('0.03'),
        9,
...
const main = async () => {
    for (var i = 0; i < testCase.length; i++) {
        ...
        if (
            ...
            charityExpectedBalance +
                parseFloat(ethers.formatEther(charityBalance1))
        ) {
            console.log(
                `Charity balance is correct: ${ethers.formatEther(
                    charityBalance
                )}`
            )
        } else {
            console.log(
                `Charity balance is incorrect: ${ethers.formatEther(
                    charityBalance
                )}, expected: ${
                    charityExpectedBalance +
                    parseFloat(ethers.formatEther(charityBalance1))
        ...
        if (
            parseFloat(ethers.formatEther(drawBalance)) ==
            drawExpectedBalance + parseFloat(ethers.formatEther(drawBalance1))
        ) {
            console.log(
                `Draw balance is correct: ${ethers.formatEther(drawBalance)}`
            )
        } else {
            console.log(
                `Draw balance is incorrect: ${ethers.formatEther(
                    drawBalance
                )}, expected: ${
                    drawExpectedBalance +
                    parseFloat(ethers.formatEther(drawBalance1))
                }`
            )
        }
