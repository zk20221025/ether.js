...
const wallet5 = new ethers.Wallet(privateKey6, provider)

const privateKey7 =
    'e59c2b05a341927c724e23d74e0cba6028816189d5f7f13def1c2b12731b193e'
const wallet5 = new ethers.Wallet(privateKey7, provider)

const privateKey8 =
    '4cdefe87fa6abb35e7e1987eebc3d19fdd675ba6e6a8362132056c90e725ef69'
const wallet5 = new ethers.Wallet(privateKey8, provider)

const privateKey9 =
    '25eeb050f0cf7cd77c2122f24a904f517022d21d9ddfad006d1044f0a5339d37'
const wallet5 = new ethers.Wallet(privateKey9, provider)

const privateKey10 =
    '549d7e0bd45bfb8e2b5da6b15b413e4c55c2ea83ac5ee7ab7ba3cf7be26ad06c'
const wallet5 = new ethers.Wallet(privateKey10, provider)
